<%-- 
    Document   : DriverAdmin
    Created on : 31 Mar, 2019, 9:56:34 PM
    Author     : KARTIK
--%>

<%@page import="model.BusesDao"%>
            ...
            <div class="admin-pages">
                <div class="route">
                    <table class="tbl1">
                        ...
                        <tr>    
                        <% 
                            BusesDao b1 = new BusesDao();
                            List<Buses> list = BusesDao.getListOfBuses();
                            for(Buses b : list){
                        %>
                        <tr>
                            <td><%=b.getBusId()%></td>
                            <td><%=b.getDriverName()%></td>
                            <td><%=b.getDriverNumber()%></td>
                            <td>
